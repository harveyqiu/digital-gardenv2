...
在我回答了我自己这个问题之后，我倒是找到了一个比较适合我的搜索软件，叫做[Recoll](https://www.lesbonscomptes.com/recoll/)。它似乎解决了我的问题。将我Obsidian笔记的文件夹添加进去之后，我发现我能方便的搜索我在Obsidian Vault中存放的内容，但这和我直接在Obsidian中进行搜索有什么区别呢？我又问自己。

区别就在于Recoll搜索任何我添加进去之后它索引的内容。我将过去的一些我从[简阅](http://ksria.com/simpread/)中导出的内容也导入了进去。我想，之后如果我有需求，我也将DayOne中我记录的日记以json格式或者pdf格式导出，在Twitter中将我发的Tweets[导出](https://help.twitter.com/en/managing-your-account/how-to-download-your-twitter-archive)。只要能够以文件形式存放在我的电脑中，理论上使用recoll都可以搜索。
